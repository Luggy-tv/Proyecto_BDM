        ...
        <form  method="post" id="form-signin" enctype="multipart/form-data" action="upload.php">
            <div class="row gx-3 mx-5">
                ...
                <div class="col-6 mb-4">
                    ...
                    <input minlength="5" maxlength="50" id="email" type="email" class="form-control" name="email" placeholder="ejemplo@mail.com" required >
                </div>
                ...
                <div class="col-4 mb-4">
                    ...
                    <input minlength="1" maxlength="30" id="nombre" type="text" class="form-control" name="nombre" placeholder="Juan Armando" required >
                </div>
                   
                <div class="col-4 mb-4">
                    <label for="ApellidoPat" class="from-label">Apellido Paterno</label>
                    <input minlength="3" maxlength="30" id="apellidoPat" type="text" class="form-control" name="ApellidoPat" placeholder="Martinez" required>
                </div>

                <div class="col-4 mb-4">
                    <label for="ApellidoMat" class="from-label">Apellido Materno</label>
                    <input minlength="3" maxlength="30" id="apellidoMat" type="text" class="form-control" name="ApellidoMat" placeholder="Perez" required>
                </div>   

                <div class="col-7 mb-4">
                    <label for="FechaDeNacimiento" class="form-label">Fecha de Nacimiento</label>
                    <input id="fechaDeNac" type="date" class="form-control" autocomplete="off" name="FechaDeNacimiento" required>
                </div>
